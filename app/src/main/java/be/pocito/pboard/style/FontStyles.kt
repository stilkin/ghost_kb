...
object FontStyles {
     ...
     */
    val DOUBLE_STRUCK: Map<Char, String> =
        mapOf(
     ...
     * Unicode range: Mathematical Alphanumeric Symbols
     */
    val CURSIVE_BOLD: Map<Char, String> =
        mapOf(
     ...
     * Unicode range: Mathematical Alphanumeric Symbols
     */
    val FRAKTUR_BOLD: Map<Char, String> =
        mapOf(
     ...
     */
    val SMALL_CAPS: Map<Char, String> =
        mapOf(
     ...
     */
    val BUBBLE_BLACK: Map<Char, String> =
        mapOf(
            'a' to "🅐", 'b' to "🅑", 'c' to "🅒", 'd' to "🅓", 'e' to "🅔", 'f' to "🅕",
            'g' to "🅖", 'h' to "🅗", 'i' to "🅘", 'j' to "🅙", 'k' to "🅚", 'l' to "🅛",
            'm' to "🅜", 'n' to "🅝", 'o' to "🅞", 'p' to "🅟", 'q' to "🅠", 'r' to "🅡",
