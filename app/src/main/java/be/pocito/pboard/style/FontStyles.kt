 ...
 * 
 * Each style contains a map of standard ASCII characters to their Unicode equivalents.
...
object FontStyles {
    ...
    val CURSIVE_BOLD = mapOf(
        ...
        'y' to '𝒚', 'z' to '𝒛',
        'A' to '𝑨', 'B' to '𝑩', 'C' to '𝑪', 'D' to '𝑫', 'E' to '𝑬', 'F' to '𝑭',
    ...
    val FRAKTUR = mapOf(
        ...
        'y' to '𝔶', 'z' to '𝔷',
        'A' to '𝔄', 'B' to '𝔅', 'C' to '𝔆', 'D' to '𝔇', 'E' to '𝔈', 'F' to '𝔉',
     ...
     */
    fun getMapping(style: FontStyle): Map<Char, Char> {
        return when (style) {
